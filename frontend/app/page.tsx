...
export default function LandingPage() {
  ...
  return (
    <PublicShell>
      <div className="mx-auto grid w-full max-w-[1600px] gap-6 xl:grid-cols-[minmax(0,1.16fr)_minmax(0,0.84fr)] xl:items-stretch">
        <section className="relative overflow-hidden rounded-[1.25rem] border border-slate-900/10 bg-[radial-gradient(circle_at_top_left,rgba(10,132,208,0.18),transparent_28%),linear-gradient(160deg,#eef5fb_0%,#dfe8f2_42%,#d3dee8_100%)] p-6 shadow-[0_20px_54px_rgba(15,23,42,0.10)] sm:p-8 xl:min-h-[calc(100svh-8rem)] dark:border-white/10 dark:bg-[radial-gradient(circle_at_top_left,rgba(79,193,255,0.14),transparent_24%),linear-gradient(160deg,#1f252d_0%,#1a2330_45%,#10253c_100%)] dark:shadow-[0_24px_70px_rgba(0,0,0,0.34)]">
          ...
          <div className="relative z-10 grid gap-8 lg:min-h-[calc(100svh-10rem)] lg:content-between">
        ...
        <section className="grid gap-4 xl:grid-rows-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
          <article className="rounded-[1.25rem] border border-slate-900/10 bg-[rgba(244,246,248,0.9)] p-6 shadow-[0_20px_54px_rgba(15,23,42,0.10)] backdrop-blur-[18px] dark:border-white/10 dark:bg-[rgba(54,59,68,0.9)] dark:shadow-[0_24px_70px_rgba(0,0,0,0.34)]">
