    ...
    <AppShell>
      <section className={panelClass}>
        ...
        <article className={nestedPanelClass}>
          <h2 className={sectionTitleClass}>Billing readiness</h2>
          <p className={ledeClass}>Billing is still simulated in this MVP, but this page is ready to connect to a real subscription provider later.</p>
        </article>
      </section>
    </AppShell>
  );
